...
public function UsersUpdated_put($id)
{
    ...
    $data = [
            ...
            'met'                       => $this->put('met', TRUE),
            'exp_met'                   => $this->put('exp_met', TRUE),
            'skill'                     => $this->put('skill', TRUE),
            'scheme'                    => $this->put('scheme', TRUE),
            ...
            'office'                    => $this->put('office', TRUE),
            'office_phone'              => $this->put('office_phone', TRUE),
            'training'                  => $this->put('training', TRUE),
            'work_exp'                  => $this->put('work_exp', TRUE),
            'teach_exp'                 => $this->put('teach_exp', TRUE),
            'scientific_work'           => $this->put('scientific_work', TRUE),
            'special_sub'               => $this->put('special_sub', TRUE),
            'npwp'                      => $this->put('npwp', TRUE),
